...
* Don't offer to generate tasks.json if build task already exists. (PR [#1363](https://github.com/muhammadsammy/free-vscode-csharp/issues/1363)) _(Contributed by [@eamodio](https://github.com/eamodio))_
